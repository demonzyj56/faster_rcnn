function script_fast_rcnn_VOC2007_ZF_leoyolo_resnet_simple()
% script_fast_rcnn_VOC2007_ZF_leoyolo_resnet_simple()
% Fast rcnn training and testing with model modified from Zeiler & Fergus'.
% Add only one deconv/conv unit mimicing resnet.
% --------------------------------------------------------
% Fast R-CNN
...
% model
model                       = Model.ZF_leoyolo_resnet_simple_for_Fast_RCNN_VOC2007();
% cache name
opts.cache_name             = 'fast_rcnn_VOC2007_ZF_leoyolo_resnet_simple';
% config
